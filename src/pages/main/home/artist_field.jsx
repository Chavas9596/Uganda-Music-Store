...
const PopularCarousel = () => {
    ...
    return (
        <div className="mx-auto max-w-8xl px-6 lg:px-8 my-8" style={{ transform: 'scale(.7)' }}>
            <h1 className="text-center text-6xl mb-10">Popular and New Artist</h1>
            <div style={{ position: "relative" }}>
                <Carousel swipeable={true} infinite={true} partialVisible={false} responsive={responsive} autoPlay={true} autoPlaySpeed={4000} rewindWithAnimation={true} rewind={true}>
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <img style={{ objectFit: 'cover', height: 308, width: '100%' }} className="selector rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-8.jpg" alt="" />
                        <div className="p-5">
                            <Link to='/'>
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Noteworthy technology acquisitions 2021</h5>
                            </Link>
                    ...
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <img style={{ objectFit: 'cover', height: 308, width: '100%' }} className="selector rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-9.jpg" alt="" />
                        <div className="p-5">
                            <Link to='/'>
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Noteworthy technology acquisitions 2021</h5>
                            </Link>
                    ...
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <img style={{ objectFit: 'cover', height: 308, width: '100%' }} className="selector rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-11.jpg" alt="" />
                        <div className="p-5">
                            <Link to='/'>
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Noteworthy technology acquisitions 2021</h5>
                            </Link>
